...
void GameApp::Startup(void)
{
	...
	m_SSAO = std::make_unique<SSAO>(g_DisplayWidth, g_DisplayHeight, DXGI_FORMAT_R32G32B32A32_FLOAT, DXGI_FORMAT_R16_UNORM);
...
void GameApp::SetPsoAndRootSig()
{
	...
	D3DReadFileToBlob(L"shader/NormalPS.cso", &NormalPS);
