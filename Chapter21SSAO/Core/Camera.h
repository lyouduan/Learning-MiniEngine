...
namespace Math
{
	...
	public:
		// call this function once per frame and after you've changed any state.
		// this regenerates all matrices. Calling it more or less than once per frame will break
		...
		void SetRotaion(Quaternion basisRotation);
	...
	protected:
		...
		// once division by W has occurred, the final coordinates can be transformed by the 
		// viewport matrix to screen space.
