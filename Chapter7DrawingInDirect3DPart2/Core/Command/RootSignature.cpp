...
void RootSignature::Finalize(const std::wstring& name, D3D12_ROOT_SIGNATURE_FLAGS Flags)
{
    ...
    // caclcuate the hash of rootDesc
    ...
    // avoid compiling the root signature repeatedly
    ...
    bool firstCompile = false;
    {
        ...
        if (iter == s_RootSignatureHashMap.end())
        {
            ...
            RSRef = iter->second.GetAddressOf(); // get the compiled root signature
    }
